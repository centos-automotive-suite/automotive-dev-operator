...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CosignKeylessIdentity) DeepCopyInto(out *CosignKeylessIdentity) {
	*out = *in
	if in.FulcioRootCARef != nil {
		in, out := &in.FulcioRootCARef, &out.FulcioRootCARef
		*out = new(corev1.ConfigMapKeySelector)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CosignKeylessIdentity.
func (in *CosignKeylessIdentity) DeepCopy() *CosignKeylessIdentity {
	if in == nil {
		return nil
	}
	out := new(CosignKeylessIdentity)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OSBuildsConfig) DeepCopyInto(out *OSBuildsConfig) {
	*out = *in
	...
	if in.TaskBundleCosignKeyless != nil {
		in, out := &in.TaskBundleCosignKeyless, &out.TaskBundleCosignKeyless
		*out = new(CosignKeylessIdentity)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *WorkspacesConfig) DeepCopyInto(out *WorkspacesConfig) {
	*out = *in
	...
	if in.ImageCosignKeyless != nil {
		in, out := &in.ImageCosignKeyless, &out.ImageCosignKeyless
		*out = new(CosignKeylessIdentity)
		(*in).DeepCopyInto(*out)
	}
}
